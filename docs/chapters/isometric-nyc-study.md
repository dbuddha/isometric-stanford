...
1. Google Photorealistic 3D Tiles were rendered through a fixed orthographic
   Three.js camera into textured reference views precisely aligned with the
   whitebox tile grid.
...
Isometric Stanford adopts the registered orthographic reference and static
delivery lessons while rejecting generated final pixels. Qwen infill is
replaced with deterministic obstruction repair plus guarded world-coordinate
processing. Style is explicit code, palette, masks, material rules, lighting,
patterns, and accepted Stanford goldens. This keeps seams, provenance, and
